---
title: "Circular Economy: indicators and measurements"
date: 2025-11-28 Fri 11:36
...
## Measuring circular economy in the EU
...
[Monitoring framework - Circular economy - Eurostat](https://ec.europa.eu/eurostat/web/circular-economy/monitoring-framework)

## Macro level
For my [DYNAMO](/id202511110900/) project, which focuses on the Finnish markets, the most important macro level indicators are

- **Circular material use rate (CMUR, “circularity rate”)** – share of total material use that comes from recycled materials. EU-27 was about **11.8 % in 2023**, with a Green Deal target to roughly double to 23.2 % by 2030 ([European Commission](https://ec.europa.eu/eurostat/web/products-eurostat-news/w/ddn-20251119-1)). 
	- Finland is at the very bottom of the EU league table: recent estimates put CMUR **somewhere in the low single digits** (2–4.5 % depending on year and method), versus >20 % in the Netherlands and Italy ([Circular Business Practices: More profit with less material usage](https://talk.turkuamk.fi/yrittajyys/circular-business-practices-more-profit-with-less-material-usage/)). 
- **Material footprint / raw material consumption (RMC)** – raw materials used globally to satisfy domestic demand, per capita and per euro of GDP. Newly elevated to a core indicator in the revised framework ([UNECE](https://unece.org/sites/default/files/2023-03/S3_3_Update%20on%20revised%20EU%20monitoring%20framework%20CE.pdf)). 
...
- **Resource productivity** – GDP divided by domestic material consumption. This is essentially “how much value per tonne”. 
	- It doesn’t directly measure circularity, but it’s what ministries and DG ENV look at when they ask whether circular policies hurt or help competitiveness ([Remeikienė et al. 2024: Assessment of the circular economy indicators in the EU Member States](https://doi.org/10.1007/s43621-024-00719-z)).
- **Waste generation and recycling rates** – total municipal waste, packaging waste by material, construction and demolition waste, % recycled, % landfilled or incinerated [(Eurostat: Circular economy - material flows)](https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Circular_economy_-_material_flows). 
...
- **Secondary raw materials and trade** – indicators for trade in recyclable materials and “import dependency” for key materials, now explicitly part of the EU monitoring revision ([UNECE](https://unece.org/sites/default/files/2023-03/S3_3_Update%20on%20revised%20EU%20monitoring%20framework%20CE.pdf)). For CRMs in particular, this is the bridge from circularity to security-of-supply.
...
- **End-of-life recycling rate** for specific metals (cobalt, nickel, rare earths, lithium, etc.). 
	- This tells how much secondary supply is technically recovered at end-of-life; for most rare earths this is still <10 %, while some battery metals are higher [(Eurostat: Circular economy - material flows)](https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Circular_economy_-_material_flows). 
...
- **C&D waste recovery rate**, split into:
    ...
    - low-value backfilling or downcycling.
	    - EU’s 70 % target has been met mainly via downcycling; Finland is still below 60 % utilisation of C&D waste, and much of that is low-value uses ([Circular economy in the construction sector - Ministry of the Environment](https://ym.fi/en/circular-economy-in-the-construction-sector)). 
	    - For market analysis, the interesting number is the high-value share.
- **Recycled content in building materials** – % recycled aggregate in concrete, % scrap in reinforcing and structural steel, % reused components per project. 
	- The Level(s) framework already defines several of these for reporting ([Circular economy in the construction sector - Ministry of the Environment](https://ym.fi/en/circular-economy-in-the-construction-sector)). 
...
- **Per-capita textile consumption and waste** – EEA now tracks consumption and waste trends. 
	- EU textile consumption has hit record highs, with waste and exports rising in parallel ([Circularity of the EU textiles value chain in numbers - EEA](https://www.eea.europa.eu/en/analysis/publications/circularity-of-the-eu-textiles-value-chain-in-numbers)).
- **Separate collection rate for post-consumer textiles** – driven by the 2025 WFD deadline.
	- Finland has de facto collection in place since 2023, ahead of the rest of the EU ([Textile - EastCham Finland ry](https://www.eastcham.fi/finnishwastemanagement/municipal-solid-waste/recycling-and-recovery/textile/)).
- **Shares to reuse, downcycling and fibre-to-fibre recycling** – still small for true fibre-to-fibre (≈1 % globally), but this is the number that becomes “addressable feedstock” for domestic recycling industry development ([Circularity of the EU textiles value chain in numbers - EEA](https://www.eea.europa.eu/en/analysis/publications/circularity-of-the-eu-textiles-value-chain-in-numbers)).
...
The main design metric is the **Material Circularity Indicator (MCI)** developed by Ellen MacArthur Foundation ([Material Circularity Indicator \| Ellen MacArthur Foundation](https://www.ellenmacarthurfoundation.org/material-circularity-indicator)). It scores individual products (and by aggregation, companies) based on:
...
For companies, EMF’s **Circulytics** gives a broader scorecard that mixes material flow metrics with organisational enablers (strategy, innovation, people, etc.) ([Circulytics: Measuring circular economy performance \| Ellen MacArthur Foundation](https://www.ellenmacarthurfoundation.org/resources/circulytics/resources)). 
...
There is also a dizzying variety of other indicators in the literature – hundreds, by some reviews – but most are variants or composites of the above. OECD/UNECE are trying to rationalise this into a more coherent indicator set for countries, but at company level it is still a bit of a Wild West ([OECD: Monitoring Progress towards a Resource-Efficient and Circular Economy](https://www.oecd.org/content/dam/oecd/en/publications/reports/2024/06/monitoring-progress-towards-a-resource-efficient-and-circular-economy_f50297ce/3b644b83-en.pdf)).
